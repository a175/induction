...
\begin{prop}
  $n\in\NN$に対し, $\sum_{i=0}^{n}i=\frac{n(n+1)}{2}$.
\end{prop}

\begin{prop}
  $n\in\NN$に対し, $\sum_{i=0}^{n}2i=n(n+1)$.
\end{prop}

\begin{prop}
  $n\in\NN$に対し, $\sum_{i=0}^{n}(2i+1)=n^2$.
\end{prop}

\begin{prop}
  $n\in\NN$に対し, $\sum_{i=0}^{n}i^2=\frac{n(n+1)(2n+1)}{6}$.
\end{prop}

\begin{prop}
  $n\in\NN$に対し, $\sum_{i=0}^{n}(2i+1)^2=\frac{n(n+1)(2n+1)}{3}$.
\end{prop}
...
\begin{prop}
  $\sum_{i=0}^n \prod{k=0}^{m-1}(i+k)=\frac{\prod{k=0}^{m}(n+k)}{m}$
\end{prop}
